...
(cl:defmethod cl:initialize-instance :after ((m <sensor_processing>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'sensor_processing)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name soft_robot_learning-msg:<sensor_processing> is deprecated: use soft_robot_learning-msg:sensor_processing instead.")))

(cl:ensure-generic-function 'xSensor-val :lambda-list '(m))
(cl:defmethod xSensor-val ((m <sensor_processing>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader soft_robot_learning-msg:xSensor-val is deprecated.  Use soft_robot_learning-msg:xSensor instead.")
  (xSensor m))

(cl:ensure-generic-function 'ySensor-val :lambda-list '(m))
(cl:defmethod ySensor-val ((m <sensor_processing>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader soft_robot_learning-msg:ySensor-val is deprecated.  Use soft_robot_learning-msg:ySensor instead.")
  (ySensor m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<sensor_processing>)))
  ...
  "soft_robot_learning/sensor_processing")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'sensor_processing)))
  "Returns string type for a message object of type 'sensor_processing"
  "soft_robot_learning/sensor_processing")
